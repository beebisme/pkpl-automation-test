...
WebUI.setEncryptedText(findTestObject('Register/input_Confirm Password_confirmPassword'), 'dcar8LSjTAo=')

WebUI.click(findTestObject('Register/button_Register'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Register/small_Confirm password tidak boleh kurang d_a23522'), 
    0)
