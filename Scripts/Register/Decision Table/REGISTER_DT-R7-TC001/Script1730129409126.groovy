...
WebUI.setText(findTestObject('Register/input_NIP_nip'), '1234567890123456789')
...
WebUI.setEncryptedText(findTestObject('Register/input_Confirm Password_confirmPassword'), 'QIaGzQLQqqLay5EbJRYZAw==')
