...
WebUI.setEncryptedText(findTestObject('Register/input_Password_password'), 'QIaGzQLQqqILx47DpmIwdg==')

WebUI.setEncryptedText(findTestObject('Register/input_Confirm Password_confirmPassword'), 'QIaGzQLQqqILx47DpmIwdg==')
