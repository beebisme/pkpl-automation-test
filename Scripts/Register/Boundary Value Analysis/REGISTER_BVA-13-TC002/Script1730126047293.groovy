...
WebUI.setEncryptedText(findTestObject('Register/input_Password_password'), 'QIaGzQLQqqLnRlpfm1b0OWBUzfBYipPt')

WebUI.setEncryptedText(findTestObject('Register/input_Confirm Password_confirmPassword'), 'QIaGzQLQqqLnRlpfm1b0OWBUzfBYipPt')
