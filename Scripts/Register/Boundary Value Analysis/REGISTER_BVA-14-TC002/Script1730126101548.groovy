...
WebUI.setEncryptedText(findTestObject('Register/input_Password_password'), 'QIaGzQLQqqLnRlpfm1b0OYSJJpxbD9QO')

WebUI.setEncryptedText(findTestObject('Register/input_Confirm Password_confirmPassword'), 'QIaGzQLQqqLnRlpfm1b0OYSJJpxbD9QO')
