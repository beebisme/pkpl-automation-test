...
WebUI.setText(findTestObject('Object Repository/Tambah Data/input_Nama UMKM_umkm_name'), 'abcdefghijklmnopqrstuvwx')

WebUI.setText(findTestObject('Object Repository/Tambah Data/input_Pemilik UMKM_umkm_owner'), 'abcdefghijklmnopqrstuvwxyzabcdefgh')

WebUI.setText(findTestObject('Object Repository/Tambah Data/input_Link Instagram_instagram_url'), 'https://www.instagram.com/ervin_land/')

WebUI.setText(findTestObject('Object Repository/Tambah Data/input_Whatsapp_whatsapp_number'), '081912345678')

WebUI.setText(findTestObject('Object Repository/Tambah Data/input_Link Google Maps_gmaps_url'), 'https://maps.app.goo.gl/nicknameaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
